...
const memoryAdapter = (db, config)=>{
    ...
    let adapterCreator = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$better$2d$auth$2f$core$2f$dist$2f$db$2f$adapter$2f$index$2e$mjs__$5b$app$2d$route$5d$__$28$ecmascript$29$__["createAdapterFactory"])({
        config: {
            adapterId: "memory",
        ...
        adapter: ({ getFieldName, options, getModelName })=>{
            ...
            function convertWhereClause(where, model, join) {
                const execute = (where$1, model$1)=>{
                    ...
                    if (!table) {
                        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$better$2d$auth$2f$core$2f$dist$2f$env$2d$D6s$2d$lvJz$2e$mjs__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__i__as__logger$3e$__["logger"].error(`[MemoryAdapter] Model ${model$1} not found in the DB`, Object.keys(db));
                ...
                for (const baseRecord of baseRecords){
                    ...
                    for (const [joinModel, joinAttr] of Object.entries(join)){
                        ...
                        if (!joinTable) {
                            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$better$2d$auth$2f$core$2f$dist$2f$env$2d$D6s$2d$lvJz$2e$mjs__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__i__as__logger$3e$__["logger"].error(`[MemoryAdapter] JoinOption model ${joinModelName} not found in the DB`, Object.keys(db));
